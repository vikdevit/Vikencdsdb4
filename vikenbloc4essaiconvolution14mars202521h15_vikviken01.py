# -*- coding: utf-8 -*-
"""VikenBloc4essaiconvolution14Mars202521h15_vikviken01.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zH0bOX6VE1yd8mJsYuMn5df4aQkz6oXu
"""
...
def load_checkpoint():
    checkpoint_path = "/content/drive/MyDrive/essaiconv14mars21h15/checkpoint.pth"
...
for epoch in range(start_epoch, epochs):
    ...
    if epoch % 2 == 0 or epoch == 19:
        save_image(fake_imgs[:25], f"/content/drive/MyDrive/essaiconv14mars21h15/progress_epoch_{epoch}_conv.png", nrow=5, normalize=True)
...
plt.savefig("/content/drive/MyDrive/essaiconv14mars21h15/training_loss_plot_conv.png")
plt.show()
